...
partial class Main
{
    ...
    private void InitializeComponent()
    {
        ...
        system = new ToolStripMenuItem();
        systemConfig = new ToolStripMenuItem();
        ...
        menuStrip1.Items.AddRange(new ToolStripItem[] { projects, camera, pLCToolStripMenuItem, system });
        ...
        // projects
        // 
        projects.DropDownItems.AddRange(new ToolStripItem[] { ninePointCalib, measure });
        ...
        measure.Size = new Size(152, 26);
        measure.Text = "尺寸测量";
        measure.Click += measure_Click;
        // 
        // camera
        // 
        camera.DropDownItems.AddRange(new ToolStripItem[] { cameraConfig, disconnectCamera });
        camera.Name = "camera";
        ...
        disconnectPlc.Size = new Size(224, 26);
        disconnectPlc.Text = "断开PLC";
        disconnectPlc.Click += disconnectPlc_Click;
        // 
        // system
        // 
        system.DropDownItems.AddRange(new ToolStripItem[] { systemConfig });
        system.Name = "system";
        system.Size = new Size(53, 24);
        system.Text = "系统";
        // 
        // systemConfig
        // 
        systemConfig.Name = "systemConfig";
        systemConfig.Size = new Size(122, 26);
        ...
        PlcConfig.Size = new Size(224, 26);
        PlcConfig.Text = "配置 ";
