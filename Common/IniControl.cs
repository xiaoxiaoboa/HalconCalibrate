...
namespace HalconCalibration.Common {
    public class IniControl {
        ...
        public void SaveFile() {
            try {
                Write("PointConfig", "BaseX", BaseX.ToString(CultureInfo.CurrentCulture));
                Write("PointConfig", "BaseY", BaseY.ToString(CultureInfo.CurrentCulture));
                Write("PointConfig", "RotateCenterX", RotateCenterX.ToString(CultureInfo.CurrentCulture));
                Write("PointConfig", "BaseAngle", BaseAngle.ToString(CultureInfo.CurrentCulture));
                Write("PointConfig", "RotateCenterY", RotateCenterY.ToString(CultureInfo.CurrentCulture));
            }
            catch (Exception exception) {
                throw new Exception(exception.Message, exception);
            }
